...
<strong>Testability:</strong>Testing is mandatory part of programming for developers, if your software isnt tested it is viewed as you cant be certain whether the software would work reliably, you need to be able to test that your software works, that any inputs from the user will yield the results as expected.</br>
